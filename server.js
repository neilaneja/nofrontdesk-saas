...
// Stripe webhook route (needs raw body â must be before other body parsers)
// âââââââââââââââââââââââââââââââââââââââââââââ
...
// âââââââââââââââââââââââââââââââââââââââââââââ
// Root route â Landing page or dashboard redirect
...
<head>
  ...
  <title>NoFrontDesk â Automated Guest Check-In for Vacation Rentals</title>
...
<body>
  ...
  <section class="hero">
    ...
    <p>Collect guest info, verify IDs, send access codes, and process payments â all before your guests arrive. Works with 10+ property management systems.</p>
    <div class="hero-cta">
  ...
  <section class="demo-video">
    ...
    <p class="demo-sub">Guests scan a QR code, type their last name, and check themselves in â in under 90 seconds.</p>
  ...
  <section class="features">
    ...
    <div class="feature-grid">
      ...
      <div class="feature-card">
        ...
        <p>Security deposits, damage waivers, and balance collection via Stripe â fully automated with retry logic.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">&#128273;</div>
      ...
      <div class="feature-card">
        ...
        <p>Send check-in links and updates via email, SMS, or WhatsApp â automatically at the right time.</p>
      </div>
      <div class="feature-card">
        <div class="feature-icon">&#127968;</div>
